...
$lichSuDat = callAPI('GET', '/owner/lich-su-dat', null, $_SESSION['token']) ?? [];
$lichTrong = callAPI('GET', '/owner/lich-trong', null, $_SESSION['token']) ?? [];

// THÊM: LẤY YÊU CẦU THUÊ SÂN CHƯA DUYỆT
$yeuCauThue = callAPI('GET', '/owner/yeu-cau-thue', null, $_SESSION['token']) ?? [];
...
<div class="col-12 mt-4">
    <div class="card card-custom">
        <div class="card-header bg-success text-white">
            <h4 class="mb-0">Lịch đặt sân (đã thuê)</h4>
        </div>
        <div class="card-body">
            <?php if (is_array($lichSuDat) && count($lichSuDat) > 0): ?>
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        <thead class="table-light">
                            <tr>
