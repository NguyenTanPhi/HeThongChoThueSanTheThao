...
<body>
    ...
    <script>
        document.getElementById('formDatSan').addEventListener('submit', function(e) {
            e.preventDefault();
            const payload = {
                san_id: <?= (int)$san_id ?>,
                ngay: '<?= $ngay ?>',
            ...
            fetch('http://127.0.0.1:8000/api/customer/dat-san-thanh-toan', {
                    method: 'POST',
                    headers: {
                ...
                .then(d => {
                    if (d.success && d.payment_url) {
                        ...
                        alert(d.message || 'Không tạo được phiên thanh toán');
                    }
                })
